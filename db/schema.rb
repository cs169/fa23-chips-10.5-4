...
ActiveRecord::Schema.define(version: 20_231_125_195_922) do
  ...
  create_table 'representatives', force: :cascade do |t|
    ...
    t.string 'photo'
    t.integer 'photo_attachment_id'
    t.index ['photo_attachment_id'], name: 'index_representatives_on_photo_attachment_id'
  end
